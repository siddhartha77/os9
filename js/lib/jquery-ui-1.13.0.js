 ...
 */
    ...
    each(spaces, function (spaceName, space) {
        ...
        color.fn[spaceName] = function (value) {
            ...
            var ret, type = getType(value), arr = (type === "array" || type === "object") ? value : arguments,
 ...
 */
    ...
    var effectsEffectBounce = $.effects.define("bounce", function (options, done) {
        var upAnim, downAnim, refValue, element = $(this),
            // Defaults:
            mode = options.mode, hide = mode === "hide", show = mode === "show", direction = options.direction || "up",
            distance = options.distance, times = options.times || 5,
            // Number of internal animations
            anims = times * 2 + (show || hide ? 1 : 0), speed = options.duration / anims, easing = options.easing,
            // Utility:
            ref = (direction === "up" || direction === "down") ? "top" : "left",
            motion = (direction === "up" || direction === "left"), i = 0,
 ...
 */
    ...
    var effectsEffectDrop = $.effects.define("drop", "hide", function (options, done) {
        ...
        var distance, element = $(this), mode = options.mode, show = mode === "show",
            ...
            oppositeMotion = (motion === "+=") ? "-=" : "+=", animation = {
                opacity: 0
            };
 ...
 */
    ...
    var effectsEffectSize = $.effects.define("size", function (options, done) {
        ...
        var baseline, factor, temp, element = $(this),
            // Copy for children
            cProps = ["fontSize"], vProps = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
            hProps = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"],
            // Set options
            mode = options.mode, restore = mode !== "effect", scale = options.scale || "both",
	 ...
	 */
        parseDate: function (format, value, settings) {
            ...
            var iFormat, dim, extra, iValue = 0,
                ...
                month = -1, day = -1, doy = -1, literal = false, date,
	 ...
	 */
        ...
        _generateMonthYearHeader: function (inst, drawMonth, drawYear, minDate, maxDate, secondary, monthNames, monthNamesShort) {
            ...
            var inMinYear, inMaxYear, month, years, thisYear, determineYear, year, endYear,
                ...
                selectYearLabel = this._get(inst, "selectYearLabel"), html = "<div class='ui-datepicker-title'>",
                monthHtml = "";
    ...
    $.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (event) {
            var woset, hoset, isParent, isOffsetRelative, that = $(this).resizable("instance"), o = that.options,
                co = that.containerOffset, cp = that.position, pRatio = that._aspectRatio || event.shiftKey, cop = {
                    top: 0,
                    left: 0
